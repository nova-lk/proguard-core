 ...
 */
package proguard.dexfile.translator.dex;

import proguard.dexfile.reader.api.DexConstants;
import proguard.dexfile.reader.api.Field;
import proguard.dexfile.reader.api.node.DexClassNode;
import proguard.dexfile.reader.api.node.DexFieldNode;
import proguard.dexfile.reader.api.node.DexFileNode;
import proguard.dexfile.reader.api.node.DexMethodNode;
