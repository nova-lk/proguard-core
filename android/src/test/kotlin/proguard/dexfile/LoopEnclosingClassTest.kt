...
class LoopEnclosingClassTest : FreeSpec({
    "Loop enclosing class test" -{
        val smaliFile = getSmaliResource("loop-enclosing-class.smali")
...
//        programClassPool.classesAccept(ClassPrinter())
        ...
        val testClass = programClassPool.getClass("a")
        ...
        "Check if classPool has class a" - {
            programClassPool.getClass("a")
                .shouldNotBe(null)
        }

        "Check if classPool has class b" - {
            programClassPool.getClass("b")
                .shouldNotBe(null)
        }

        "Check if classPool has class c" - {
            programClassPool.getClass("c")
                .shouldNotBe(null)
        }
