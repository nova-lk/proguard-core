...
//        programClassPool.classesAccept(ClassPrinter())
        ...
        "Check if classPool contains the i/or/Z class" - {
            testClass
                .shouldNotBe(null)
        }

        "Check if etcwgh contains access$376 method" - {
            testClass
                .findMethod("access\$376", "(Lcom/google/android/finsky/widget/consumption/NowPlayingWidgetProvider\$ViewTreeWrapper;I)Z")
                .shouldNotBe(null)
        }
