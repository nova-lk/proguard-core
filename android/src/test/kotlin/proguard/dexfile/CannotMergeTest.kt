...
//        programClassPool.classesAccept(ClassPrinter())
        ...
        "Check if classPool contains android/preference/MultiSelectListPreference class" - {
            testClass
                .shouldNotBe(null)
        }

        "Check if the class contains test method" - {
            testClass
                .findMethod("test", "(Ljava/util/Set;Ljava/lang/Object;)V")
                .shouldNotBe(null)
        }
